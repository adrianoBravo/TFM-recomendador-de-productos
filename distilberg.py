...
# 5. Cargar el tokenizer y el modelo de DistilBERT preentrenado
...
pooled_output = distilbert_output[:, 0, :]  # Usar el primer token (CLS)
...
log_dir = os.path.join("logs", "fit", "distilbert_product")
...
improved_model.save("models/distilbert-product-recommendation-mejorada-zero-shot-final")
...
print("Para visualizar el entrenamiento, ejecuta: tensorboard --logdir=logs/fit/distilbert_product")
